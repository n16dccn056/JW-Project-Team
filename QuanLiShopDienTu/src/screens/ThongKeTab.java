...
public class ThongKeTab extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        OptionSP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Bán chạy", "Tồn kho", "Hết hàng" }));
        OptionSP.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                OptionSPItemStateChanged(evt);
            }
        });
    ...
    }//GEN-LAST:event_OptionSPItemStateChanged
